#ifndef HALIDE_____aot_ndk_arm___halide_mm_h
#define HALIDE_____aot_ndk_arm___halide_mm_h
#include <stdint.h>
...
int halide_mm(struct halide_buffer_t *_MA_buffer, struct halide_buffer_t *_MB_buffer, int32_t _k, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int halide_mm_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *halide_mm_metadata() HALIDE_FUNCTION_ATTRS;
